...
class $836e50e45781687c$export$3138a16edeb45799 extends (0, $5OpyM$KrThing) {
     ...
     */ #setLibraries() {
        this._schema = (0, $5OpyM$KrakenSchemas).get(this.record_type);
        this._schema.thing = this;
        this._html = new (0, $5OpyM$krakenHtml).KrakenHtmlClass(this.record, this.urlOptions);
    }
    get schema() {
        this._schema = (0, $5OpyM$KrakenSchemas).get(this.record_type);
        this._schema.thing = this;
    ...
    getProperty(propertyID) {
        ...
        let schema = (0, $5OpyM$KrakenSchemas).getItem(propertyID);
        property.schema = schema;
        for (let pv of property._propertyValues)pv.schema = schema;
        return property;
    }
    // -----------------------------------------------------
    //  Properties 
